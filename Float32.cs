...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class Float32 : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "Float32";
            public readonly string md5sum = "73fcbf46b49191e672908e50842a83d4";
            public float data;
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                data = BitConverter.ToSingle(serialized, curIndex);
