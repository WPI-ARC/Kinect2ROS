...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class Int32MultiArray : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "Int32MultiArray";
            public readonly string md5sum = "1d99f79f8b325b44fee908053e9c945b";
            ...
            public override string ToStringRaw ()
            {
                ...
                string_rep += "data:\n[";
                foreach (System.Int32 element in data)
                {
