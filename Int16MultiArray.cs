...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class Int16MultiArray : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "Int16MultiArray";
            public readonly string md5sum = "d9338d7f523fcb692fae9d0a0e9f067c";
            ...
            public override string ToStringRaw ()
            {
                ...
                string_rep += "data:\n[";
                foreach (System.Int16 element in data)
                {
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                {
                    System.Int16 element = BitConverter.ToInt16(serialized, curIndex);
