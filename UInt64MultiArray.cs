...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class UInt64MultiArray : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "UInt64MultiArray";
            public readonly string md5sum = "6088f127afb1d6c72927aa1247e945af";
            public std_msgs.MultiArrayLayout layout;
            public List<System.UInt64> data;

            public UInt64MultiArray ()
            {
                layout = new std_msgs.MultiArrayLayout();
                data = new List<System.UInt64>();
            }
            ...
            public override string ToStringRaw ()
            {
                ...
                string_rep += "data:\n[";
                foreach (System.UInt64 element in data)
                {
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                {
                    System.UInt64 element = BitConverter.ToUInt64(serialized, curIndex);
