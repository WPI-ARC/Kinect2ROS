...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class Int64MultiArray : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "Int64MultiArray";
            public readonly string md5sum = "54865aa6c65be0448113a2afc6a49270";
            ...
            public override string ToStringRaw ()
            {
                ...
                string_rep += "data:\n[";
                foreach (System.Int64 element in data)
                {
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                {
                    System.Int64 element = BitConverter.ToInt64(serialized, curIndex);
