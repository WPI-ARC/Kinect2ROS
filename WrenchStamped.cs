...
namespace ROS_CS
{
    ...
    {
        public class WrenchStamped : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "WrenchStamped";
            public readonly string md5sum = "d78d3cb249ce23087ade7e7d0c40cfa7";
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                curIndex += wrench.Deserialize(serialized, curIndex);
