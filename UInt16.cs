...
namespace ROS_CS
{
    namespace std_msgs
    {
        public class UInt16 : ROS_CS.Core.BaseMessage
        {
            public readonly string typeID = "UInt16";
            public readonly string md5sum = "1df79edf208b629fe6b81923a544552d";
            ...
            public override int Deserialize(System.Byte[] serialized, int startIndex)
            {
                ...
                data = BitConverter.ToUInt16(serialized, curIndex);
